...
class Vacancy:
    ...
    def __init__(self, item_number: int, name:str, linq: str, salary_from: Optional[int], salary_to: Optional[int]):
        ...
        self.salary_str = f'{salary_from_str} {salary_to_str} руб.' if salary_from or salary_to else f'Не указана'
    ...
    def __str__(self):
        return f'{self.name} З/П: {self.salary_str} {self.linq}'
